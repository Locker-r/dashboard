...
This runs the tests, JavaScript syntax scan, tracked-file secret scan, atomic SQL safety check, and `git diff --check`. Run `npm ci` separately after cloning or whenever the lockfile changes.
